		...
		while(menuOn) {
			...
			case 1:
				...
				case 1:
					...
					System.out.println("Votre Tamagotchi s'est bien nourri")
					break;
				case 2:
					//TODO l'option "sortir" doit mettre la joie a 10 et incrementer la fatigue
					tama.setJoie(10);
					tama.setFatigue(tama.getFatigue()+1);
					System.out.println("Votre Tamagotchi a bien aimé sa promenade")
					break;
				case 3:
					//TODO l'option "laver" doit mettre la propreté à 10
					tama.setPropreté(10);
					System.out.println("Votre Tamagotchi est désormais tout propre !")
					break;
				case 4:
					...
					tama.setFatigue(0);
					System.out.println("Votre Tamagotchi s'est calmé")
					break;
				case 0:
